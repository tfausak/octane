...
data RawReplay = RawReplay
    ...
    , rawReplayContent :: LazyBytes
    -- ^ The second section.
    , rawReplayFooter :: LazyBytes
...
$(overloadedRecord def ''RawReplay)
...
newRawReplay
    :: LazyBytes -- ^ The header.
    -> LazyBytes -- ^ The content.
    -> LazyBytes -- ^ The footer.
    -> RawReplay
...
checkCRC :: (Monad m) => Word32.Word32 -> LazyBytes -> m ()
